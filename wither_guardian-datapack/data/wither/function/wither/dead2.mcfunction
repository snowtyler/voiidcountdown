...
# MUSIC
    ...
    execute as @a run stopsound @a record wither_guardian:phase2
    execute at @e[type=item,sort=nearest,tag=nether_star,limit=1] run playsound wither_guardian:death hostile @a ~ ~ ~ 1 1
