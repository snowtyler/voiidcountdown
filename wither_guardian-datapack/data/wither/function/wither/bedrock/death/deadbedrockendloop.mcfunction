...
execute as @e[type=wither,tag=WitherGuardian,limit=1] run data modify entity @s Health set value 1.0f
execute as @e[type=minecraft:wither,tag=WitherGuardian,limit=1] run data merge entity @e[type=wither,tag=WitherGuardian,limit=1] {Invulnerable:0b,Silent:0b,Glowing:0b,Health:1f}
execute at @e[type=wither,tag=WitherGuardian,limit=1] as @p run damage @e[type=wither,tag=WitherGuardian,limit=1] 20 player_attack by @p
