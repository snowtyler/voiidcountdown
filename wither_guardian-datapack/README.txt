...
New Wither Guardian variant
- Use `/function wither:wither_guardian/summon` to spawn the custom boss without touching vanilla Withers.
- Or run `/function wither:wither_guardian/mark_nearest` to convert the closest normal Wither into a Wither Guardian.