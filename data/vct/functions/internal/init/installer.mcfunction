...
execute if score McVersion Timer matches 3802..3939 run tellraw @a ["-------------------------------------\n",{"text":"Voiid Countdown Timer","bold":true,"color":"light_purple"}," ",{"text":"can not be installed on\nthis version of Minecraft!","color":"red"},"\n\nThe ",{"text":"1.20.5 and 1.20.6","color":"yellow"}," versions are ",{"text":"incompatible","color":"red"},"\nwith Voiid Countdown Timer, you can use it\nin other compatible versions.\n\n",{"text":"We are sorry! :(","color":"aqua"},"\n-------------------------------------"]
execute if score McVersion Timer matches 3802..3939 run scoreboard players add McVersionIncompatible Timer 1
execute if score McVersion Timer matches 3802..3939 run schedule function vct:internal/api/uninstall 3s
