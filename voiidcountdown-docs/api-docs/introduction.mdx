...
<Tabs>
  <Tab title="plugin.yml">
    ...
    ```yaml Optional dependency {6} lines wrap
    name: ExamplePlugin
    version: 1.0
    author: author
    ...
    ```yaml Required dependency {6} lines wrap
    name: ExamplePlugin
    version: 1.0
    author: author
    main: your.main.path.Here
  ...
  <Tab title="paper-plugin.yml">
    ...
    ```yaml Optional dependency {6,7,8,9,10} lines wrap
    name: ExamplePlugin
    version: 1.0
    author: author
    main: your.main.path.Here
    ...
    ```yaml Required dependency {6,7,8,9,10} lines wrap
    name: ExamplePlugin
    version: 1.0
    author: author
    main: your.main.path.Here
