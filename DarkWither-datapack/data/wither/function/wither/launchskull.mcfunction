...
execute as @e[type=minecraft:wither,tag=DarkWither,limit=1] at @s run rotate @s facing entity @r eyes
...
execute as @e[type=minecraft:wither_skull,tag=skulllaunch] at @s store result score @s playerposX run data get entity @r Pos[0] 1000
execute as @e[type=minecraft:wither_skull,tag=skulllaunch] at @s store result score @s playerposY run data get entity @r Pos[1] 1000
execute as @e[type=minecraft:wither_skull,tag=skulllaunch] at @s run scoreboard players add @s playerposY 1320
execute as @e[type=minecraft:wither_skull,tag=skulllaunch] at @s store result score @s playerposZ run data get entity @r Pos[2] 1000
...
schedule function wither:wither/launchskullend 2s